...
The following is the screenshot that motivated this posting. There is more to this figure but I'm trying to only show a part of it since I'm claiming fair use here in reproducing it. The image is from [this paper](https://onlinelibrary.wiley.com/doi/abs/10.1002/nau.25127), see reference below. Notice that the blurriness is a result of their screenshot, which ideally would be avoided  by using a better plotting/exporting routine.
